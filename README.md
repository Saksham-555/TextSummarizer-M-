...
app = FastAPI(
    ...
    description="Predict math score based on student details.",
    version="1.0.0",
)

# Create global pipeline so model is loaded once
...
@app.post("/predict")
def predict_score(input_data: StudentInput):
    """
    Accepts student details and returns predicted math score.
    """
    data = CustomData(
    ...
    return {
        "predicted_math_score": float(preds[0])
    }
